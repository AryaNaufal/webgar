...
while($row = $result->fetch_assoc()) {
            ...
            <tr>
                ...
                <td><button class="btn btn-outline-info" name="reset_password"><a href="<?php echo '../delete.php?id=' . $row['id']; ?>">Delete</a></button></form></td>
                <td><form method="post"> <input type="text" name="email" value="<?php echo $row["email"] ?>" hidden><button class="btn btn-outline-info" name="view_details">View Details</button></form></td>
            </tr>
            <?php 
  }
}  
