    ...
    <div class="main">
      ...
      <div class="Basic">
        ...
        ?>
            ...
            <h6 style="margin-top: 20px; margin-left: 20px;">Age : <?= $interval->format('%y Years'); ?></h6>
                  ...
                  <tr>
                    ...
                    <td>
                      <form method="post">
                        ...
                        <input type="submit" name="edit_attendance" class="btn btn-outline-primary" value="Edit attendance">
                      </form>
                    </td>
                  </tr>
      ...
      <div class="Basic">
        ...
        ?>
            <br>
            <h6> Overall attendance percentage : <?php print($percentage);
                                                }
                                              } ?> %</h6>
            <?php
            $sql = "SELECT * FROM attendance where email='$email' and attendance='present'";
            if ($result = mysqli_query($conn, $sql)) {
              $rowcount = mysqli_num_rows($result);
            ?>
              <h6> Total Presents : <?php print($rowcount);
                                  } ?> </h6>
              <?php
              ...
              if ($result = mysqli_query($conn, $sql)) {
                $rowcount = mysqli_num_rows($result);
              ?>
                <h6> Total Absents : <?php print($rowcount);
                                    } ?> </h6>
                <?php
                ...
                if ($result = mysqli_query($conn, $sql)) {
                  $rowcount = mysqli_num_rows($result);
                ?>
                  <h6> Total Leaves : <?php print($rowcount);
                                    } ?> </h6>
      </div>
      <hr>
      <div class="Basic">
