...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="index.php"><img src="Assets/Images/logogar.png" width="100px" height="40px"></a>
...
<div class="container">
    ...
    <h3 style="text-align: center; color: #0062cc; padding: 10px; margin-top: 10px; margin-bottom: 10px;">User Form</h3>
        ...
        <form method="post" class="form-signin">
            ...
            <a href="Admin/login.php"><button class="btn btn-outline-primary btn-block">Admin Page</button></a>
        </form><!-- /form -->
    </div>
</div><!-- /container -->
